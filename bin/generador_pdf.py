...
original_pdf = os.path.join (current_folder, f"juicio.pdf")

def generatePDF(no_expediente, no_intento, fecha_convocatoria, fecha_emision, nombre, dni, basico_teorico, basico_teorico_practico, basico_practico, automatizacion_teorico, automatizacion_teorico_practico, automatizacion_practico, redes_teorico, redes_teorico_practico, redes_practico, riesgo_teorico, riesgo_teorico_practico, riesgo_practico, quirofano_teorico, quirofano_teorico_practico, quirofano_practico, lampara_teorico, lampara_teorico_practico, lampara_practico, generadora_teorico, generadora_teorico_practico, generadora_practico, rite_teorico, rite_teorico_practico, rite_practico, examinador, comentario1, comentario2, comentario3):
    packet = io.BytesIO()
    ...
    c.drawString(120, 295, examinador)
    c.drawString(20, 218, comentario1)
    c.drawString(20, 195, comentario2)
    c.drawString(20, 172, comentario3)
    c.drawString(270, 120, examinador)
    c.drawString(290, 93, fecha_emision)
    ...
    if(rite_teorico=="Apto"): 
        c.drawString(242, 330, "X")
    elif(rite_teorico=="No Apto"):
        c.drawString(282, 333, "X")
    else:
        c.drawString(323, 333, "X")

    if(rite_teorico_practico=="Apto"): 
        c.drawString(362, 333, "X")
    elif(rite_teorico_practico=="No Apto"):
        c.drawString(401, 333, "X")
    else:
        c.drawString(443, 333, "X")

    if(rite_practico=="Apto"):
        c.drawString(482, 333, "X")
    elif(rite_practico=="No Apto"):
        c.drawString(520, 333, "X")
    else:    
        c.drawString(559, 333, "X")
    ...
    new_pdf = os.path.join (files_folder, f"Juicio de Competencia_{int(no_expediente)}.pdf")
...
for i in range (4, hoja.nrows):
    ...
    fecha_convocatoria=fecha_segmentada_1[0]+"/"+fecha_segmentada_1[1]+"/"+fecha_segmentada_1[2]
    fecha_emision=fecha_segmentada_2[0]+"/"+fecha_segmentada_2[1]+"/"+fecha_segmentada_2[2]
    ...
    if(hoja.cell_value(i, 75)=="X"):
        ...
        rite_practico="No Apto"
    else:
        rite_practico="NA"

    examinador = hoja.cell_value(i, 78)
    
    comentario1 = hoja.cell_value(i, 79)

    comentario2 = hoja.cell_value(i, 80)

    comentario3 = hoja.cell_value(i, 81)

    print(examinador)

    generatePDF(no_expediente, no_intento, fecha_convocatoria, fecha_emision, nombre, dni, basico_teorico, basico_teorico_practico, basico_practico, automatizacion_teorico, automatizacion_teorico_practico, automatizacion_practico, redes_teorico, redes_teorico_practico, redes_practico, riesgo_teorico, riesgo_teorico_practico, riesgo_practico, quirofano_teorico, quirofano_teorico_practico, quirofano_practico, lampara_teorico, lampara_teorico_practico, lampara_practico, generadora_teorico, generadora_teorico_practico, generadora_practico, rite_teorico, rite_teorico_practico, rite_practico, examinador, comentario1, comentario2, comentario3)
